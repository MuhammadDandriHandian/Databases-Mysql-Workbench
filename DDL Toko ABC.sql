...
(
    ...
    IDShop varchar(10) references TrShop(IDShop) on update cascade,
    Name varchar(50) not null,
    Stock int not null,
    Price int not null
);
...
(
    ...
    IDProduct int references MsProduct(IDProduct) on update cascade,
    IDCustomer int references TrCustomer(IDCustomer) on update cascade,
...
(
    ...
    Comment varchar(100),
    Star char(1)
    constraint star check (Star like '1' or Star like '2' or Star like '3' or Star like '4' or Star like '5')
);
...
insert into TrCustomer (Name, PhoneNumber, Email) values 
